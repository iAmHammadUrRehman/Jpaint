...
public class DialogProvider implements IDialogProvider {
    ...
    private final IDialogChoice<ColorAdapter> choosePrimaryColorDialog;
    private final IDialogChoice<ColorAdapter> chooseSecondaryColorDialog;
    ...
    @Override
    public IDialogChoice<ColorAdapter> getChoosePrimaryColorDialog() {
        return choosePrimaryColorDialog;
    }

    @Override
    public IDialogChoice<ColorAdapter> getChooseSecondaryColorDialog() {
