...
public class Choose_Secondary_Color_Dialog implements I_Dialog_Choice<Color_Adapter> {

    private final I_Application_State application_State;
    private final ArrayList<Color_Adapter> colors;

    public Choose_Secondary_Color_Dialog(I_Application_State application_State) {
    ...
    public Color_Adapter get_Current_Selection() {
        return application_State.get_Active_Secondary_Color();
    }
}
